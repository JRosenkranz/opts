package io.github.jrosenkranz.opts.java_api.set;

import io.github.jrosenkranz.opts.java_api.Opts;
import io.github.jrosenkranz.opts.options.Opt;
import scala.Option;
...
public class OptSet {
    private io.github.jrosenkranz.opts.set.OptSet optSet;
    ...
    private OptSet(Opt<Object>... options) {
        ...
        this.optSet = new io.github.jrosenkranz.opts.set.OptSet(seq);
    }

    public Optional<Opts> parse(String[] args, boolean commandRequired) {
        Option<io.github.jrosenkranz.opts.Opts> opts = optSet.parse(args, commandRequired);
